...
***
# Programming skills
A list of languages that I've used before, listed in order of highest to lowest familiarity.
...
## Frameworks
```
1. Laravel (very little experience though)
```
...
## Network
network layers, IPv4, IPv6, gateways, subnets, TCP/UDP packets, DHCP, firewall, routers, switches and hubs, access points, VLAN, ethernet cabling, wireless communication
...
### Posters and papers presented at scientific meetings
