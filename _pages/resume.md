...
| analysis | note |
|:---:|:---:|
| [Multinomial modeling](https://en.wikipedia.org/wiki/Multinomial_distribution) | Design and analysis of multinomial models.  Group and individual level analysis.  Simple or multi-level embedded models. |
| [Multi-level ](https://en.wikipedia.org/wiki/Multilevel_model) | Also known as random coefficient modeling and hierarchical modeling. For continuous or discrete variables. |
| [Regression ](https://en.wikipedia.org/wiki/Regression_analysis) | Linear regression, logistic (or any other family) regression, one or multiple predictors. |
| [ANOVA](https://en.wikipedia.org/wiki/Analysis_of_variance) | One- or multi-way ANOVA, repeated measures ANOVA, multivariate ANOVA, ANCOVA. |
| [Chi-squared](https://en.wikipedia.org/wiki/Chi-squared_test) | Various chi-squared tests. |
| [Path ](https://en.wikipedia.org/wiki/Path_analysis_(statistics)) | - |
