...
# Changelog
**Mar 15th, 2022**: It's been a while since I last updated this article but all the information here is still up-to-date. You can track changes to my curated `m3u` playlists and related utility scripts on my [tvhlink Github repository](https://github.com/cgomesu/tvhlink).
